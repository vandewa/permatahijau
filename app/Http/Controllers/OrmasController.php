...
class OrmasController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
      ...
      $lawas =   Ormas::find($id);
        ...
        if($request->filled('nama_organisasi')){
            ...
            if($jika){
                activity()->log('Mengubah Nama Organisasi');
            }
    ...
    {
        $activity_log = ActivityLog::with('user')->limit(10)->orderBy('created_at', 'desc')->get();

        // return $activity_log;

        return view('admin.ormas.log', compact('activity_log'));
