@section('title', 'Dashboard SIUPH ( Sistem Informasi UPZ Permata Hijau )')
@extends('layout.main')
@section('content')
<!-- BEGIN: Content-->
            ...
            <div class="card-content">
              <div class="media align-items-stretch">
                ...
                <div class="p-2 bg-gradient-x-primary white media-body">
                  <h5>Total Warga</h5>
                  <h5 class="text-bold-400 mb-0"><i class="feather icon-user"></i> {{ $warga }}</h5>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-content">
              <div class="media align-items-stretch">
                ...
                <div class="p-2 bg-gradient-x-danger white media-body">
                  ...
                  <h5 class="text-bold-400 mb-0"><i class="feather icon-activity"></i>{{ $penerima }}</h5>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-content">
              <div class="media align-items-stretch">
                ...
                <div class="p-2 bg-gradient-x-success white media-body">
                  <h5>Total Uang</h5>
                  <h5 class="text-bold-400 mb-0"><i class="feather icon-arrow-up"></i> {{ $uang }}</h5>
                </div>
              </div>
            </div>
          </div>
