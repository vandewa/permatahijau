...
@section('title', 'Pengeluaran Hadiyani & Partners Law Firm')
  ...
  <div class="row">
    <div class="col-xl-6 col-md-6 mb-6">
      <div class="card shadow h-100 py-2">
        <div class="card-body">
          <form action="{{ url('admin/keuangan/pengeluaran') }}" method="POST">
            @csrf
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    Data pengeluaran akan dihapus secara permanen dan tidak dapat dikembalikan.
                                  </div>
