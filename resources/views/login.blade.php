...
<body
  style="background-image: url({{ asset('front/assets/image/login.jpg')}}); background-repeat : no-repeat; background-position: center bottom; background-size: cover;">
              ...
              <form class="user" action="/login" method="post">
                ...
                <div class="form-group">
                  <input type="email"
                    ...
                    id="exampleInputEmail" placeholder="Username" name="username" value="{{ old('username') }}">
                  @error('username')
