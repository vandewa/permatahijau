    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true" > 
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" navigation-header"><span>Zakat</span><i class=" feather icon-minus" data-toggle="tooltip" data-placement="right" data-original-title="Zakat"></i>
                </li>
                ...
                <li class="nav-item {{ request()->routeIs('admin:penerimaan-zakat*') ? 'active' : '' }}"><a href="{{ route('admin:penerimaan-zakat.index') }}"><i class="feather icon-list"></i><span class="menu-title" data-i18n="Beras dan Uang">Beras dan Uang</span></a>
                </li>

                <li class="nav-item {{ request()->routeIs('admin:beras*') ? 'active' : '' }}"><a href="{{ route('admin:beras') }}"><i class="feather icon-list"></i><span class="menu-title" data-i18n="Beras">Beras</span></a>
                </li>

                <li class="nav-item {{ request()->routeIs('admin:uang*') ? 'active' : '' }}"><a href="{{ route('admin:uang') }}"><i class="feather icon-list"></i><span class="menu-title" data-i18n="Uang">Uang</span></a>
                </li>
                
                <li class=" navigation-header"><span>Warga</span><i class=" feather icon-minus" data-toggle="tooltip" data-placement="right" data-original-title="Warga"></i>
                </li>
                <li class=" nav-item {{ request()->routeIs('admin:warga*') ? 'active' : '' }}"><a href="{{ route('admin:warga.index') }}"><i class="feather icon-users"></i><span class="menu-title" data-i18n="Data User">Data Warga</span></a>
                </li>
