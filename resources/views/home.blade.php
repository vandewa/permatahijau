  ...
  <main id="content" role="main">
    <!-- Hero Section -->
    <div class="position-relative bg-img-hero" style="background-image: url({{ asset('front/assets/svg/components/abstract-shapes-14.svg')}});">
          ...
          <div class="row justify-content-lg-center align-items-md-center">
            <div class="col-md-5 mb-11 mb-md-0">
              <div class="position-relative">
                <img class="img-fluid rounded-lg" src="{{ asset('front/assets/image/zakat.jpg')}}" alt="Image Description">

                <!-- SVG Elements -->
                <figure class="max-w-19rem w-100 position-absolute bottom-0 left-0 z-index-n1">
                  <div class="mb-n7 ml-n7">
                    <img class="img-fluid" src="{{ asset('front/assets/svg/components/dots-2.svg')}}" alt="Image Description">
                  </div>
                </figure>
                <!-- End SVG Elements -->
              </div>
        ...
        <div class="row justify-content-lg-between align-items-lg-center">
          <div class="col-md-10 col-lg-5 mb-9 mb-lg-0">
            ...
            <div id="testimonialsNavMain" class="js-slick-carousel slick mb-4"
                ...
                <div class="js-slide">
                    <blockquote class="h3 text-white font-weight-normal mb-4"><em>"Dan laksanakanlah salat dan tunaikanlah zakat. Dan segala kebaikan yang kamu kerjakan untuk dirimu, kamu akan mendapatkannya (pahala) di sisi Allah. Sungguh, Allah Maha Melihat apa yang kamu kerjakan"</em></blockquote>
                    {{-- <span class="h5 text-white">Al-Qur'an</span> --}}
                    <small class="d-block text-white-70"><b>(QS. Al-Baqarah:110)</b></small>
                </div>

                <div class="js-slide">
                    <blockquote class="h3 text-white font-weight-normal mb-4"><em>"Dan pada harta benda mereka ada hak untuk orang miskin yang meminta dan orang miskin yang tidak meminta"</em></blockquote>
                    {{-- <span class="h5 text-white">Al-Qur'an</span> --}}
                    <small class="d-block text-white-70"><b>(QS. Az-Zariyat:92)</b></small>
                  </div>

                <div class="js-slide">
                    <blockquote class="h3 text-white font-weight-normal mb-4"><em>"Ambillah zakat dari harta mereka, guna membersihkan dan menyucikan mereka, dan berdoalah untuk mereka. Sesungguhnya doamu itu (menumbuhkan) ketenteraman jiwa bagi mereka. Allah Maha Mendengar, Maha Mengetahui"</em></blockquote>
                    {{-- <span class="h5 text-white">Al-Qur'an</span> --}}
